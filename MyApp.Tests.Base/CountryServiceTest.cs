...
namespace MyApp.Tests.Base
{
    public class CountryServiceTest
    {
        ...
        private readonly Mock<ICountryRepository> mockCountryRepo;
        private readonly Mock<ICountryApiService> mockCountryApi;
        ...
        public CountryServiceTest()
        {
            ...
            mockCountryApi = new Mock<ICountryApiService>();
        }
        [Fact]
        ...
        public async Task GetAllCountries_SkipCache_GetCountriesFromDbThenCache()
        {
            ...
            mockCacheService.Setup(m => m.Get<List<CountryContract>?>(CacheKeys.Countries)).Returns((IResult<List<CountryContract>>)new Result<List<CountryContract>>());
